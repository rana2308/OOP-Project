...
//    DATABASE TOOLS
    ...
    public void addMedicinesAdd(){
        ...
        String sql = "INSERT INTO event"
        		+ " (event_ID, brand, productName, type, status, price, image, date) "
                + "VALUES(?,?,?,?,?,?,?,?)";
    ...
    public ObservableList<Event> addMedicinesListData(){
        ...
        try{
            ...
            while(result.next()){
                medData = new Event(result.getInt("event_ID"), result.getString("brand")
    ...
    public void purchaseAdd(){
        ...
        String sql = "INSERT INTO customer (customer_id,type,event_ID,brand,productName,quantity,price,date)"
                + " VALUES(?,?,?,?,?,?,?,?)";
        ...
        try{
            ...
            if(purchase_type.getSelectionModel().getSelectedItem() == null
                ...
                String checkData = "SELECT price FROM medicine WHERE event_ID = '"
    ...
    public void purchaseType(){
        ...
        String sql = "SELECT type FROM event WHERE status = 'Available'";
    ...
    public void purchaseBrand(){
        ...
        String sql = "SELECT * FROM medicine WHERE event_ID = '"
                +purchase_medicineID.getSelectionModel().getSelectedItem()+"'";
    ...
    public void purchaseProductName(){
        ...
        String sql = "SELECT * FROM event WHERE brand = '"
	 ...
	 public void defaultNav(){ dashboard_btn.
	 setStyle("-fx-background-color:linear-gradient(to bottom right, #41b170, #8a418c);"
	  ); }
